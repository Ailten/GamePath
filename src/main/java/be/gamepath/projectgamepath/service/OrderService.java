...
public class OrderService {
     ...
     */
    public Order insert(EntityManager em, Order entityToInsert)
    {
     ...
     */
    public Order update(EntityManager em, Order entityToUpdate)
    {
     ...
     */
    public void delete(EntityManager em, Order entityToDelete){
